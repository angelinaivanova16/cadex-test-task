<img src="https://github.com/angelinaivanova16/cadex-test-task/actions/workflows/workflow.yml/badge.svg" alt="sign of workflow state">
...
## GitFlow
- Сообщения коммитов должны нести осмысленную информацию и следовать правилам именования:
  - feat - добавлен или удален код в директории src;
  - fix - исправление ошибки;
  - refactor - новой функциональности не добавлял / поведения не менял. Файлы в другие места положил, удалил, добавил;
  - perf - произведено улучшение производительности;
  - style - произведены "косметические" изменения (форматирование);
  - test - изменение .test файлов;
